...
<div class="botton_center">
	...
	<input type="text" name="${param.no}"  required><br>
	<br>
	<div class="stu-name">名前</div>
	<input type="text" name="${param.name}" required><br>
	<br>
	<div class="stu-year">入学年度</div>
	<input type="text" name="${param.ent_year}" required><br>
	<br>
	<div class="stu-clsCd">クラスコード</div>
	<select name="${param.class_num}" class="stu-clsCDBox" required>
	...
	<select name="${param.isattend}" class="stu-zaisekiBox" required>
	<option value="">在籍状況を選択</option>
	<option value="TRUE">在籍</option>
	</select><br>
	<br>
	<div class="stu-schoolCd">学校コード</div>
	<select name="${param.school_cd}" class="stu-schoolCdBox" required>
	<option value="">学校コードを選択
